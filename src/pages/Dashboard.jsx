          ...
          {DASHBOARD_DATA_REG.map(({ id, title, openDate, closeDate, status, link1, link2 }) => (
            <div key={id} className="bg-forest-card border p-4 rounded-lg flex flex-col shadow-md shadow-forest-light-green card-zoom">
              ...
              <div className="flex justify-center mt-6">
                <a href={link1} target="_blank" rel="noopener noreferrer" className="bg-blue-600 text-white py-2 px-4 rounded-md text-center hover:bg-blue-900">Modul 9</a>
                <a href={link2} target="_blank" rel="noopener noreferrer" className="bg-orange-600 text-white py-2 px-4 rounded-md text-center hover:bg-orange-900 ml-2">Modul 2</a>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {DASHBOARD_DATA_INTER.map(({ id, title, openDate, closeDate, status, link1, link2 }) => (
            <div key={id} className="bg-forest-card border p-4 rounded-lg flex flex-col shadow-md shadow-forest-light-green card-zoom">
              ...
              <p className="text-forest-light-gray mb-4">Status: {status}</p>
              <div className="flex justify-center mt-6">
                <a href={link1} target="_blank" rel="noopener noreferrer" className="bg-blue-600 text-white py-2 px-4 rounded-md text-center hover:bg-blue-900">Closed</a>
                <a href={link2} target="_blank" rel="noopener noreferrer" className="bg-orange-600 text-white py-2 px-4 rounded-md text-center hover:bg-orange-900 ml-2">Closed</a>
              </div>
            </div>
          ))}
        </div>
